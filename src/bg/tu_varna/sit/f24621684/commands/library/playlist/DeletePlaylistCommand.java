...
public class DeletePlaylistCommand implements Command {
     ...
     */
    public DeletePlaylistCommand(StateManager stateManager) {
    ...
    public String execute(String[] args) {
        ...
        if (args.length < 1) return "Error: Usage - deleteplaylist <name>";
     ...
     */
    @Override
    public String getDescription() { return "(deleteplaylist <name>) deletes a playlist"; }
}